...
let link_LF_HIP = link_LF_HAA_drive * UnitQuaternion::from_axis_angle(&Unit::new_unchecked(Vector3::new(1.0, 0.0, 0.0)), joint_cmds[0]);
...
let link_LF_THIGH = link_LF_HFE_output * UnitQuaternion::from_axis_angle(&Unit::new_unchecked(Vector3::new(-1.0, 0.0, 0.0)), joint_cmds[1]);
...
let link_LF_SHANK = link_LF_KFE_drive * UnitQuaternion::from_axis_angle(&Unit::new_unchecked(Vector3::new(1.0, 0.0, 0.0)), joint_cmds[2]);
...
let link_RF_HIP = link_RF_HAA_drive * UnitQuaternion::from_axis_angle(&Unit::new_unchecked(Vector3::new(1.0, 0.0, 0.0)), joint_cmds[3]);
...
let link_RF_THIGH = link_RF_HFE_output * UnitQuaternion::from_axis_angle(&Unit::new_unchecked(Vector3::new(1.0, 0.0, 0.0)), joint_cmds[4]);
...
let link_RF_SHANK = link_RF_KFE_drive * UnitQuaternion::from_axis_angle(&Unit::new_unchecked(Vector3::new(-1.0, 0.0, 0.0)), joint_cmds[5]);
...
let link_LH_HIP = link_LH_HAA_drive * UnitQuaternion::from_axis_angle(&Unit::new_unchecked(Vector3::new(-1.0, 0.0, 0.0)), joint_cmds[6]);
...
let link_LH_THIGH = link_LH_HFE_output * UnitQuaternion::from_axis_angle(&Unit::new_unchecked(Vector3::new(-1.0, 0.0, 0.0)), joint_cmds[7]);
...
let link_LH_SHANK = link_LH_KFE_drive * UnitQuaternion::from_axis_angle(&Unit::new_unchecked(Vector3::new(1.0, 0.0, 0.0)), joint_cmds[8]);
...
let link_RH_HIP = link_RH_HAA_drive * UnitQuaternion::from_axis_angle(&Unit::new_unchecked(Vector3::new(-1.0, 0.0, 0.0)), joint_cmds[9]);
...
let link_RH_THIGH = link_RH_HFE_output * UnitQuaternion::from_axis_angle(&Unit::new_unchecked(Vector3::new(1.0, 0.0, 0.0)), joint_cmds[10]);
...
let link_RH_SHANK = link_RH_KFE_drive * UnitQuaternion::from_axis_angle(&Unit::new_unchecked(Vector3::new(-1.0, 0.0, 0.0)), joint_cmds[11]);
...
let link_inspection_payload_pan = link_inspection_payload_mount * Translation3::new(0.0, 0.0, 0.023) * UnitQuaternion::from_axis_angle(&Unit::new_unchecked(Vector3::new(0.0, 0.0, 1.0)), joint_cmds[12]);
let link_inspection_payload_tilt = link_inspection_payload_pan * Translation3::new(0.03, 0.0, 0.152) * UnitQuaternion::from_axis_angle(&Unit::new_unchecked(Vector3::new(0.0, 1.0, 0.0)), joint_cmds[13]);
